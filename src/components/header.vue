<template>
  ...
  <div>
    ...
    <!--<div id="alert-success" role="alert" class="alert alert-success top displaynone" style="width: 400px;">-->
      <!--<button @click="hideThisSuccessAlert()" type="button" class="close"><span>×</span></button>-->
      <!--<span class="glyphicon glyphicon-ok-sign"></span>-->
      <!--<strong>提示信息</strong>-->
      <!--<p id="success-tips"></p>-->
    <!--</div>-->

    <!--<div id="alert-danger" role="alert" class="alert alert-danger top displaynone" style="width: 400px;">-->
      <!--<button @click="hideThisDangerAlert()" type="button" class="close"><span>×</span></button>-->
    ...
    <!--<nav class="navbar navbar-default">-->
      <!--<div class="container-fluid">-->
        <!--<div class="navbar-header">-->
          <!--<a class="navbar-brand">vue-lala</a>-->
        <!--</div>-->
    ...
    <div class="row" style="margin-right:0px;margin-bottom:15px;">
      <div class="col-md-6 col-md-offset-3" style="padding-left: 0px;padding-right: 0px">
        <div class="menu-header" id="poi-header" style="background-color: rgb(249, 245, 239)">
          <ul>
            <li route="/index"><span @click="pathTo('/index')" class="active">菜单一</span></span></li>
            <li route="/timeline"><span @click="pathTo('/timeline')" > 菜单二</span></li>
          </ul>
        </div>
      </div>
    </div>
